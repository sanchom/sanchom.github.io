...
regard to this diversity.◊note{◊cite-case[#:title "Reference re
Secession of Quebec" #:citation "[1998] 2 SCR 217" #:pinpoint "paras
55--60" #:url
...
powers."◊note{◊cite-case[#:url
"https://scc-csc.lexum.com/scc-csc/scc-csc/en/item/234/index.do"
#:title "Ontario (Attorney General) v OPSEU" #:citation "[1987] 2 SCR
2" #:pinpoint "para 27"]} One way that this overlap plays out is
through the double-aspect doctrine.

◊em{Multiple Access Ltd v McCutcheon}◊note{◊cite-case[#:title
"Multiple Access Ltd v McCutcheon" #:citation "[1982] 2 SCR 161" #:url
"https://scc-csc.lexum.com/scc-csc/scc-csc/en/item/2450/index.do"]},
...
enactments as valid."◊note{◊em{Ibid} at 233.}
...
side by side.◊note{◊em{Ibid} at para 67.}  }
